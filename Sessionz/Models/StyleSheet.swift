...
enum Stylesheet {
    ...
    enum Colors {
        static let customPurple = UIColor(hex: "#73529E")
    ...
    enum Contexts {
        ...
        enum NavigationController {
            ...
            static let BarTextColor = Colors.customPurple
