...
class CreateAccountViewController: UIViewController {
    ...
    var accountInfoVC = AccountInfoViewController()
    var nav = AccountInfoNavController()
    ...
    override func viewDidLoad() {
        ...
        createAccountView.passwordTextField.delegate = self
         createAccountView.createButton.addTarget(self, action: #selector(create), for: .touchUpInside)
...
extension CreateAccountViewController: AuthUserDelegate {
    ...
    func didCreateUser(_ userService: AuthUserService, user: User) {
        //TODO show page vc
        self.present(nav.storyboardInstance(), animated: true, completion: nil)
